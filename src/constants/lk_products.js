...
const LK_SOFT_STARTERS_PRODUCTS = [
    {
    ...
    },
    {
        ...
        image: "/logo.png", // Path needs to be updated
...
const LK_ALL_PRODUCTS = [
    ...LK_AC_DRIVE_PRODUCTS,
    ...LK_SOFT_STARTERS_PRODUCTS,
    ...LK_HMI_PRODUCTS,
    ...LK_SERVO_PRODUCTS
]

export { LK_AC_DRIVE_PRODUCTS, LK_SOFT_STARTERS_PRODUCTS, LK_HMI_PRODUCTS, LK_SERVO_PRODUCTS, LK_ALL_PRODUCTS };