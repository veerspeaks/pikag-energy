  ...
  return (
    ...
    >
      <div className="container mx-auto">
        <h2 className="text-4xl font-bold text-center mb-10 tracking-wider">Our <span className='text-primary'>Clients</span></h2>
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
          {clients.map(client => (
            ...
            >
              <img src={client.src} alt={client.alt} className="max-h-24" />
            </motion.div>
          ))}
        </div>
      </div>
