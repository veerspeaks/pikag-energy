                    ...
                    <main className="mt-8 sm:mt-10 mx-auto max-w-7xl px-4 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                        <div className="flex flex-col lg:flex-row items-center justify-between">
                            <div className="text-center lg:text-left lg:max-w-2xl" data-aos="fade-right">
                                <h1 className="text-3xl sm:text-4xl tracking-tight font-extrabold text-dark sm:text-5xl md:text-6xl">
                                    <span className="block">Discover Our</span>
                                    <span className="block text-primary">
                                        Premium Products
                                    </span>
                                </h1>
                                <p className="mt-3 text-sm sm:text-base text-gray-700 sm:mt-5 sm:text-lg sm:max-w-xl md:mt-5 md:text-xl">
                                ...
                                <div className="mt-6 sm:mt-8 flex flex-wrap justify-center lg:justify-start gap-3 sm:gap-4">
                                    ...
                                    <Link
                                        ...
                                        className="inline-flex items-center px-6 sm:px-8 py-2.5 sm:py-3 border-2 border-primary text-sm sm:text-base font-medium rounded-md text-primary hover:bg-primary hover:text-white transition-all duration-300"
                                    >
                                        View All
                                    </Link>
                                </div>
                            ...
                            <div className="mt-8 sm:mt-12 lg:mt-0 lg:ml-8" data-aos="fade-left">
                                <img
                                    ...
                                    className="w-full max-w-xs sm:max-w-sm md:max-w-md rounded-lg shadow-md transform hover:scale-102 transition-all duration-300"
                                />
                            </div>
                        </div>
                    </main>
