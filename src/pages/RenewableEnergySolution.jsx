...
const RenewableEnergySolution = () => {
  ...
  const solution = offerings.find(item => item.id === "renewable-energy");
      ...
      <div className="relative bg-gray-900">
        ...
        <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
          ...
          <p className="mt-6 max-w-3xl text-xl text-gray-300">
            Industry-leading solar panel systems that deliver sustainable energy and significant cost savings for your business.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              We collaborate with industry-leading manufacturers to provide you with the best renewable energy solutions.
            </p>
          </div>
            ...
            <div>
              ...
              <div className="mt-8 space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <p className="ml-3 text-base text-gray-500">
                    Government incentives and tax benefits for renewable energy adoption
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Explore our range of high-quality renewable energy products and systems.
            </p>
          </div>
      ...
      <div className="bg-primary">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
            <span className="block">Ready to switch to renewable energy?</span>
...
export default RenewableEnergySolution 